...
file_matches = `find . -name "*.html" -o -name "*.css" -o -name "*.yml" -o -name "*.rb" -o -name "*.erb" -o -name "*.txt" | grep #{ARGV[0]}`.split("\n")
...
content_matches = `find . -name "*.html" -o -name "*.css" -o -name "*.yml" -o -name "*.rb" -o -name "*.erb" -o -name "*.txt"`.split("\n")
